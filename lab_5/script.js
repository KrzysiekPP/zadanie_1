...
var adding_button = document.getElementById('adding_button');
...
//ADD EVENT TO "NEW ELEMENT"s BUTTON (ADD NEW ELEMENT)
adding_button.addEventListener('click', function(){

    var newElement = document.createElement('LI');

    newElement.innerHTML= "<button class='button'>X</button>  [Nowy element  " + new_element_text + "]";
